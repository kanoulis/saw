    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="cbox mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <h2>Client payments</h2>
                    <div>
                        <span>Filter date range: </span>
                        <input type="text" id="daterange" name="datefilter" />
        ...
        <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" /> <script>
            $(function() {
                ...
                $('input[name="datefilter"]').on('apply.daterangepicker', function(ev, picker) {
                    ...
                    $.post( "/api/datefilter", { startDate: startDate, endDate: endDate } )
                    .done(function( data ) {
                        data = data.clients;
                        $('#client-list').html('');
                        var innerHTML = '';
                        for (var i = 0; i < data.length; i++){
                            ...
                            innerHTML += '<td>' + moment(data[i].created_at).utcOffset(0).format('YYYY-MM-DD HH:mm:ss') + '</td>';
                            innerHTML += '<td>' + data[i].amount +'</td>';
                            innerHTML += '</tr>';
                        }
                        $('#client-list').html(innerHTML);
                    });
                });
